...
#' @return a vectgor of coefficients from the final fitted model with top 10 features
#' @author amarquezp
#' @details This funtion runs a univariate regression of y on each predictor in x and
...
#'
#' This function takes a set of coefficients produced by the \code{topten} function and makes
#' a prediction for each of the values provided in the input 'X' matrix
#'
#' @param X an n x 10 matrix containing n new observations
